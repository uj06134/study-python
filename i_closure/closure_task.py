...
#
#
# # set_user(외부함수)를 user_service라는 변수에 담는다.
# user_service = set_user()
#
# # set_user()에서 return값인 딕셔너리에서 insert에 'han'을 넣은 값을 가져온다.
# # (han)인 이유는 내부함수가 insert(name)이기 떄문이다.
...
post_service.get('insert')(number=6, title='테스트 제목6', content='테스트 내용6', file='')
print(post_info)
